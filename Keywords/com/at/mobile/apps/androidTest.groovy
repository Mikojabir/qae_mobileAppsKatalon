...
public class androidTest {
	...
	def menuAccessbility( ) {
		...
		if (elIsChecked3 == true) {
			for (def i=0; i < 2; i++) {
				Mobile.tap(findTestObject('Mobile Apps/Android/DemoTest/List Menu/Accessbility/default.CheckBox3'), 1, FailureHandling.STOP_ON_FAILURE)
		 ...
		 */
		Mobile.delay(1)
		//Conquer World checked
		def elNotCheck1 = Mobile.verifyElementNotChecked(findTestObject('Mobile Apps/Android/DemoTest/List Menu/Accessbility/elementNotCheck1'), 3)
		if (elNotCheck1 == true) {
				Mobile.tap(findTestObject('Mobile Apps/Android/DemoTest/List Menu/Accessbility/elementNotCheck1'), 1, FailureHandling.STOP_ON_FAILURE)
				KeywordUtil.markPassed("Conquer World checked - Successfully")
		...
		Mobile.delay(1)
		//Do Taxes
		def elNotCheck2 = Mobile.verifyElementNotChecked(findTestObject('Mobile Apps/Android/DemoTest/List Menu/Accessbility/elementNotCheck2'), 3)
		if (elNotCheck2 == true) {
				Mobile.tap(findTestObject('Mobile Apps/Android/DemoTest/List Menu/Accessbility/elementNotCheck2'), 1, FailureHandling.STOP_ON_FAILURE)
				KeywordUtil.markPassed("Do Taxes checked - Successfully")
		...
		Mobile.delay(1)
		//Abolish IRS
		def elNotCheck3 = Mobile.verifyElementNotChecked(findTestObject('Mobile Apps/Android/DemoTest/List Menu/Accessbility/elementNotCheck3'), 3)
		if (elNotCheck3 == true) {
				Mobile.tap(findTestObject('Mobile Apps/Android/DemoTest/List Menu/Accessbility/elementNotCheck3'), 1, FailureHandling.STOP_ON_FAILURE)
				KeywordUtil.markPassed("Abolish IRS checked - Successfully")
			} else {
			KeywordUtil.markError("not successfully")
		}
		...
		def elNotCheck4 = Mobile.verifyElementNotChecked(findTestObject('Mobile Apps/Android/DemoTest/List Menu/Accessbility/elementNotCheck4'), 3)
		if (elNotCheck4 == true) {
				Mobile.tap(findTestObject('Mobile Apps/Android/DemoTest/List Menu/Accessbility/elementNotCheck4'), 1, FailureHandling.STOP_ON_FAILURE)
				KeywordUtil.markPassed("Tea with Aunt Sharon checked - Successfully")
			} else {
			KeywordUtil.markError("not successfully")
		}
